...
public class MybatisPlus {
    public static void main(String[] args) {
        ...
        //手动配置数据源
        String url="jdbc:mysql://111.229.35.32:3306/networkdisk?serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=utf-8&useSSL=true&remarks=true&useInformationSchema=true";   //注意修改数据库名
        String name="kane";
        String password="kane123456";

        //数据库表的设置
        List<String> listTable = Arrays.asList("nwd_user");  //设置需要自动代码生成的表名
        List<String> listTableSuffix = Arrays.asList("_nwd");    //设置 过滤 表的后缀
        List<String> listTablePrefix = Arrays.asList("nwd_","nwd_"); //设置 过滤 表的后缀

        //基本信息
        String author = "wk";    //作者
        String parent = "com";   //父包名
        String module = "nwd";   //模块包名
